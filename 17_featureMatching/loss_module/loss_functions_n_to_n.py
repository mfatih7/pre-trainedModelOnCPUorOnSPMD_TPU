...
def calculate_ess_loss_and_L2loss( config, logits, xs_ess, R_device, t_device, virtPt_device ):
    
    e_hat = weighted_8points(xs_ess, logits)
    ...
    # e_hat = loss_functions.weighted_8points(xs_ess, logits)
    ...
    # outputs_model_B = model_B(logits)
